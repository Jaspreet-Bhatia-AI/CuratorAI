    ...
    <AnimatePresence>
      {needRefresh && (
        <motion.div
          ...
          exit={{ y: -50, opacity: 0 }}
          className="fixed top-24 left-1/2 -translate-x-1/2 z-[100] flex items-center gap-4 bg-gradient-to-r from-google-purple to-blue-500 text-slate-900 dark:text-white px-6 py-3 rounded-full shadow-2xl border border-white/20"
        >
          ...
          <div className="flex items-center gap-2 border-l border-white/20 pl-4">
            ...
            <button 
              onClick={close}
              className="text-slate-900 dark:text-white/70 hover:text-slate-900 dark:text-white p-1"
            >
