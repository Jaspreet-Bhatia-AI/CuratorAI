  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white/5 border border-white/10 p-12 rounded-3xl backdrop-blur-xl max-w-lg w-full shadow-2xl"
      >
        <h1 className="text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-600 mb-4">
          404
        </h1>
        <h2 className="text-2xl font-bold text-white mb-6">Lost in the Algorithm</h2>
